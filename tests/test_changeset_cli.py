...
class TestInitCommand:
    ...
    def test_init_creates_changeset_directory(self, cli_runner: CliRunner, temp_repo: Path):
    ...
    def test_init_handles_existing_directory(self, cli_runner: CliRunner, initialized_changeset_project: Path):
...
class TestAddCommand:
    ...
    def test_add_creates_changeset_interactive(self, cli_runner: CliRunner, initialized_changeset_project: Path, mocker):
        ...
        mocker.patch('changeset.changeset.questionary.checkbox', return_value=mocker.Mock(
        ...
        mocker.patch('changeset.changeset.questionary.confirm', return_value=mocker.Mock(
    ...
    def test_add_with_all_flag(self, cli_runner: CliRunner, multi_package_project: Path, mocker):
        ...
        select_mock.return_value.ask.side_effect = ['patch', 'patch']  # One for each package
...
class TestVersionCommand:
    ...
    def test_version_bumps_package_version(self, cli_runner: CliRunner, initialized_changeset_project: Path):
...
Added new feature
"""
        (initialized_changeset_project / ".changeset" / "test-change.md").write_text(changeset_content)
        ...
        assert not (initialized_changeset_project / ".changeset" / "test-change.md").exists()
    ...
    def test_version_dry_run(self, cli_runner: CliRunner, sample_changeset: Path):
        ...
        assert sample_changeset.name in [f.name for f in (project_dir / ".changeset").glob("*.md")]
    
    def test_version_no_changesets(self, cli_runner: CliRunner, initialized_changeset_project: Path):
...
class TestCheckChangesetCommand:
    ...
    def test_check_changeset_on_main_branch(self, cli_runner: CliRunner, initialized_changeset_project: Path):
    ...
    def test_check_changeset_on_feature_branch_without_changeset(self, cli_runner: CliRunner, initialized_changeset_project: Path):
    ...
    def test_check_changeset_on_feature_branch_with_changeset(self, cli_runner: CliRunner, sample_changeset: Path):

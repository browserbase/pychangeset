...
"""
        ...
        assert len(result) == 2
        assert result[0] == ("my-package", "minor", "This is a test changeset with multiple packages")
        assert result[1] == ("other-package", "patch", "This is a test changeset with multiple packages")
